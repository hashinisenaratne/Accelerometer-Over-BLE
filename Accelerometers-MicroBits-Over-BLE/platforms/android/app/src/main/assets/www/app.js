...
app.activities = [	
	...
	['Heel_tap_sit_R', 10],//55
	['Heel_tap_sit_L', 10],//65
	['Heel_tap_sit_B', 10],//75
	['Scissors_sit', 10],//85
	['Toe_tap_sit_R', 10], //95
	['Toe_tap_sit_L', 10], //105
	['Toe_tap_sit_B', 10], //115
	['Swing_on_knee_R', 10], //125
	['Swing_on_knee_L', 10], //135
	['Jiggle_R', 10], //145
	['Jiggle_L', 10], //155
	...
	['Toe_tap_stand_R', 10], //210
	['Toe_tap_stand_L', 10], //220	
	['Heel_tap_stand_R', 10], //230
	['Heel_tap_stand_L', 10], //240
...
app.append = function(data, file) {
	window.resolveLocalFileSystemURL(cordova.file.externalRootDirectory, function(dirEntry) {//dataDirectory
